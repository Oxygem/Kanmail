...
import hmac
import smtplib
from smtplib import _MAXCHALLENGE, SMTPAuthenticationError, SMTPException, encode_base64
...
class SMTP(smtplib.SMTP):
    ...
    def auth_cram_md5(self, challenge=None):
        ...
        if challenge is None:
            return None
        return (
            self.user + " " + hmac.HMAC(self.password.encode("utf-8"), challenge, "md5").hexdigest()
        )
