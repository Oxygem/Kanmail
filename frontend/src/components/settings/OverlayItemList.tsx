...
// function makeMixin(name, stateKey, BaseClass = React.Component): React.Component {
...
interface IOverlayItemListProps {
  itemComponent: typeof React.Component;
  itemFormComponent: typeof React.Component;
  newItemFormComponent: typeof React.Component;
...
interface IOverlayItemListState {
  addingItem: boolean;
  editingItemIndex: number | null;
}

export default class OverlayItemList extends React.Component<IOverlayItemListProps, IOverlayItemListState> {
